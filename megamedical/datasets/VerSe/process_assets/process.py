    ...
    try:
        ...
        if len(rtp) > 0:
            if item['subdset'] == "VerSe19":
                im_dir = os.path.join(dset_info[item['subdset']]["image_root_dir"], file_name, f"{file_name}_ct.nii.gz")
                label_dir = os.path.join(dset_info[item['subdset']]["label_root_dir"], file_name, f"{file_name}_seg-vert_msk.nii.gz")
            else:
                im_dir = os.path.join(dset_info[item['subdset']]["image_root_dir"], file_name, f"{file_name}_dir-ax_ct.nii.gz")
                label_dir = os.path.join(dset_info[item['subdset']]["label_root_dir"], file_name, f"{file_name}_dir-ax_seg-vert_msk.nii.gz")
