    ...
    def __init__(self):
        ...
        self.dset_info = {
            "retreived_2022_03_08":{
                "main":"LITS",
                "image_root_dir":f"{paths['ROOT']}/megamedical/datasets/LITS/processed/original_unzipped/retreived_2022_03_08/media/nas/01_Datasets/CT/LITS/volumes",
                "label_root_dir":f"{paths['ROOT']}/megamedical/datasets/LITS/processed/original_unzipped/retreived_2022_03_08/media/nas/01_Datasets/CT/LITS/segmentations",
                "modality_names":["CT"],
                "planes":[0, 1, 2],
                "clip_args":[-500,1000],
                "norm_scheme":"CT",
