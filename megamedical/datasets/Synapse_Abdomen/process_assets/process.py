...
class Synapse_Abdomen:
    ...
    def proc_func(self,
        ...
        subj_dict, res_dict = proc.process_image_list(process_Synapse_Abdomen_image,
                                                      proc_dir,
                                                      task,
                                                      image_list,
                                                      parallelize,
...
global process_Synapse_Abdomen_image
def process_Synapse_Abdomen_image(item):
    try:
        ...
        if len(rtp) > 0:
            ...
            label_dir = os.path.join(dset_info[item['subdset']]["label_root_dir"], item['image'].replace("img","label"))
