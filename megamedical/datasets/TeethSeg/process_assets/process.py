...
class TeethSeg:
    ...
    def __init__(self):
        ...
        self.dset_info = {
            "Challenge2017":{
                "main":"TeethSeg",
                "image_root_dir":f"{paths['DATA']}/TeethSeg/processed/original_unzipped/Challenge2017/training",
                "label_root_dir":f"{paths['DATA']}/TeethSeg/processed/original_unzipped/Challenge2017/training",
                "modality_names":["MRI"],
                "planes":[2],
                "clip_args":None,
                "norm_scheme":None,
    ...
    def proc_func(self,
        ...
        subj_dict, res_dict = proc.process_image_list(process_TeethSeg_image,
                                                      proc_dir,
                                                      task,
                                                      image_list,
                                                      parallelize,
...
global process_TeethSeg_image
def process_TeethSeg_image(item):
    try:
