...
class PROMISE12:
    ...
    def proc_func(self,
        ...
        subj_dict, res_dict = proc.process_image_list(process_PROMISE12_image,
                                                      proc_dir,
                                                      image_list,
                                                      parallelize,
                                                      pps_function,
...
global process_PROMISE12_image
def process_PROMISE12_image(item):
    try:
        ...
        if len(rtp) > 0:
            ...
            label_dir = os.path.join(dset_info[item['subdset']]["label_root_dir"], f"{item['image'][:-7]}_segmentation.nii.gz")
