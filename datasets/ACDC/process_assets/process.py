...
class ACDC:
    ...
    def __init__(self):
        self.dataset_info_dictionary = {
            "Challenge2017":{
                "main":"ACDC",
                "image_root_dir":"/home/vib9/src/data/ACDC/processed/original_unzipped/Challenge2017/training",
                "label_root_dir":"/home/vib9/src/data/ACDC/processed/original_unzipped/Challenge2017/training",
                "modality_names":["MRI"],
                "planes":[2],
                "clip_args":None,
                "norm_scheme":"MR",
        ...
        """
            "Scribbles":{
                "main":"ACDC",
                "image_root_dir":"/home/vib9/src/data/ACDC/processed/original_unzipped/Challenge2017/training",
                "label_root_dir":"/home/vib9/src/data/ACDC/processed/original_unzipped/Scribbles/acdc_scribbles",
                "modality_names":["MRI"],
                "planes":[2],
                "clip_args":None,
                "norm_scheme":"MR",
            ...
            for image in image_list:
                try:
                    if redo_processed or (len(glob.glob(os.path.join(processed_dir, "*", image))) == 0):
                        im_dir = os.path.join(dset_info["image_root_dir"], image, f"{image}_frame01.nii.gz")
                        if dset_name == "Challenge2017":
                            label_dir = os.path.join(dset_info["label_root_dir"], image, f"{image}_frame01_gt.nii.gz")
                        else:
                            label_dir = os.path.join(dset_info["label_root_dir"], f"{image}_frame01_scribble.nii.gz")
