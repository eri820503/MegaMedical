...
dataset_info_dictionary = {
    "retrieved_2021_10_11":{
        "main":"LGGFlair",
        "image_root_dir":"/home/vib9/src/data/LGGFlair/processed/original_unzipped/retrieved_2021_10_11",
        "label_root_dir":"/home/vib9/src/data/LGGFlair/processed/original_unzipped/retrieved_2021_10_11",
        ...
        for image in image_list:
            try:
                if redo_processed or (len(glob.glob(os.path.join(processed_dir, "*", image))) == 0):
                    file_dir = os.path.join(dset_info["image_root_dir"], image)
                    image_file_list = []
                    label_file_list = []
